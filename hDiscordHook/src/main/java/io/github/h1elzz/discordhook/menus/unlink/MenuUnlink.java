package io.github.h1elzz.discordhook.menus.unlink;
...
public class MenuUnlink extends PlayerMenu {


    public MenuUnlink(Profile profile) {
        super(profile.getPlayer(), "Desvincular - Confirmação", 3);
